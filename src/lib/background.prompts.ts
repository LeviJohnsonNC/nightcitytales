...
const LIFEPATH_BACKGROUND = [
  ...
  "The character's Role is the spine of the story, not a footnote. This must read as the origin of THAT Role specifically: a Solo's background tastes of combat, contracts, and surviving what others didn't; a Netrunner's of systems, scores, and the black wall's shadow; a Fixer's of deals, contacts, and favors owed. Use the Role answers as the through-line — they are the player's own account of how the character came to the work — and let the Role's ability color what the character is good at and known for. A reader who finished the piece should be able to name the Role without being told.",
  "Do not invent game mechanics, STATs, cyberware, skills, or rules; narrative color only.",
  "Use second person, present tense.",
  "Structure: at least 3 paragraphs, 300 to 450 words total. Paragraph one covers where you came from, family, and childhood. Paragraph two covers the turn or crisis that made you who you are — and that turn should be the road that led to your Role. Paragraph three covers the people who matter, friends, enemies, and any tragic love. A final short paragraph lands on where you stand now as your Role and what you are chasing.",
