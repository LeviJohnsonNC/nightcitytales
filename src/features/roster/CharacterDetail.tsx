    ...
    <div className="space-y-6">
      <header className="no-print flex flex-wrap items-center justify-between gap-3 border-b border-border pb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {/*
            One button. Which job the character takes, if any, is theirs to
            decide on the opening screen rather than a reader's choice made from
            a character list before the fiction has started.
          */}
