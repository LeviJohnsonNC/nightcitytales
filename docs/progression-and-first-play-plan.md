...
| `walk_the_block`  | Opens at the home place with its intel already open; stays in LIFE         |
| `handle_business` | Seeds a `need` situation carrying the money pressure; stays in LIFE        |
